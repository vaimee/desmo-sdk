...
const desmoHub_module_1 = require("./desmoHub-module");
...
class DesmoContract extends desmoHub_module_1.DesmoHub {
    constructor(walletSigner) {
        ...
        try {
            // @ts-ignore
            this.iexec = new iexec_1.IExec({ ethProvider: walletSigner.wallet });
        }
        catch (e) {
